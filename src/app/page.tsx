...
const Cards: ICard[] = [
    ...
    },
    {
        ...
        href: "https://vercel.com/templates?framework=next.js&utm_source=create-next\
        -app&utm_medium=appdir-template&utm_campaign=create-next-app",
    },
    {
        title: "Deploy",
...
const classNames = {
    ...
    nextLogo:
        "relative flex place-items-center before:absolute before:h-[300px] before:w-[480px]\
...
export default function Home() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            ...
            <div className={classNames.nextLogo}>
                <Image
